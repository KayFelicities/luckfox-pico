...
export RK_PRE_BUILD_OEM_SCRIPT=kay-post-patch.sh
...
export RK_PARTITION_CMD_IN_ENV="256K(env),256K@256K(idblock),512K(uboot),4M(boot),16M(oem),40M(rootfs),180M(userdata)"
